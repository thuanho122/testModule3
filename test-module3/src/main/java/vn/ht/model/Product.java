...
public class Product {
    ...
    public Product(String name, double price, int quantity, String color, int categoryId) {
        this.name = name;
        this.price = price;
    ...
    public Product(int id, String name, double price, int quantity, String color, int categoryId, String categoryName) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.quantity = quantity;
